...
EXEC_FILES = find_cmd_path.c pipeline.c pipeline_util.c redirect_io.c redirect_in.c redirect_out.c heredoc.c heredoc_util.c heredoc_expand.c builtin_cmd.c astree2list.c
