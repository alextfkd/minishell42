...
void							log_debug_show_token(t_token *token_head,
									t_loglevel log_level);
void							log_debug_show_ast(t_astree *ast_root,
									t_loglevel log_level);
...
char							**rebuild_envp(t_env *env_list,
									char **current_envp);
